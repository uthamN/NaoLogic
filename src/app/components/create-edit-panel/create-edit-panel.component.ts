...
export class CreateEditPanelComponent {
  ...
  get currentStatus(): WorkOrderStatus { return this.f['status'].value as WorkOrderStatus; }
  ...
  closeStatusDropdown() { this.statusOpen.set(false); }
